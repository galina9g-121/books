...
# Открываем страницу Labirint
url = "https://www.labirint.ru/series/38260/"
driver.get(url)
...
df.to_csv("labirint_books.csv", index=False, encoding="utf-8-sig")

print("✅ Данные успешно сохранены в 'labirint_books.csv'")
